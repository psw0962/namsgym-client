...
const FitnessHome = () => {
  ...
  return (
    <Container>
      <div style={{ marginRight: '50px' }} onClick={() => setTest(false)}>
        한개일경우
      </div>
      <div onClick={() => setTest(true)}>여러개일경우</div>
      ...
      {test ? (
        <div>
          ...
          <div style={{ marginBottom: '50px', width: '50px' }}>
            <ProgressBar
              className="wrapper"
          ...
          <TestWrapper>
            <ImageWrapper key="1" width={40} height={40}>
              <Image
                src={kickback}
                alt="bridge"
                priority={true}
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '20rem' }}>
            ...
            <NextWrapper>
              <div style={{ fontSize: '50px' }}>{`Next >>>>>`}</div>

              <ImageWrapper key="1" width={20} height={20}>
                <Image
                  src={bridge}
                  alt="bridge"
                  priority={true}
